...
<header>
    <div class="buttons">
        ...
        <button class="btn" onclick="location.href='adduser.php';"><img style=" width:97%" src="datagix.png" alt="datagix"></button>
        <button style="" class="btn" onclick="location.href='docteurs.php';"> List docteurs</button>
    </div>
</header>
<body>
        <div id = "leftbox">
            <div style="min-height:450px;background-color:white;padding:2px;">
                <table class='msg' style="width:98%;  margin:1%; ">
                    <tr style="border:none;">
                        <td class="thatcolor" colspan="2" style=" height: auto;"><a href="messages.php"><h3 style='display:inline;'>les messages:</h3></a></td>
                    </tr>   
                    <?php
